...
class Fund(models.Model):
    ...
    buying = models.DecimalField(max_digits=32, decimal_places=2, default=0)
    redemption = models.DecimalField(max_digits=32, decimal_places=2, default=0)
    dividends = models.DecimalField(max_digits=32, decimal_places=2, default=0)
    total_injected = models.DecimalField(max_digits=32, decimal_places=2)
    cash_balance = models.DecimalField(max_digits=32, decimal_places=2, default=0)
    cost = models.DecimalField(max_digits=32, decimal_places=2, default=0)
    market_value = models.DecimalField(max_digits=32, decimal_places=2, default=0)
    total_asset = models.DecimalField(max_digits=32, decimal_places=2)
    unrealized = models.DecimalField(max_digits=32, decimal_places=2)
    per_unrealized = models.DecimalField(max_digits=32, decimal_places=2)
    realized = models.DecimalField(max_digits=32, decimal_places=2)
    cumul_realized = models.DecimalField(max_digits=32, decimal_places=2)
    gross_nav = models.DecimalField(max_digits=32, decimal_places=2)
    expenses = models.DecimalField(max_digits=32, decimal_places=2, default=0)
    net_nav = models.DecimalField(max_digits=32, decimal_places=2)
    shares = models.DecimalField(max_digits=32, decimal_places=2)
    nav_share = models.DecimalField(max_digits=32, decimal_places=2)
    per_variation = models.DecimalField(max_digits=32, decimal_places=2)
    cumul_variation = models.DecimalField(max_digits=32, decimal_places=2)
    set = models.DecimalField(max_digits=32, decimal_places=2, default=0)
    set_var = models.DecimalField(max_digits=32, decimal_places=2)
